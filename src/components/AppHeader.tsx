import { User, Shield, Moon, Sun, LogIn, ShoppingCart, Inbox, Search } from "lucide-react";
    ...
    <header className="sticky top-0 z-40 bg-background/80 backdrop-blur-md border-b border-border">
      <div className="flex items-center justify-between h-14 px-4 max-w-7xl mx-auto">
        ...
        <div className="flex items-center gap-1">
          <Link to="/search" className="h-9 w-9 rounded-lg flex items-center justify-center text-muted-foreground hover:text-foreground hover:bg-accent transition-colors" aria-label="Search">
